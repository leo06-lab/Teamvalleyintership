...
function JobApplications() {
  ...
  const getCvLink = (cvPath) => {
    if (!cvPath) return "";
    return getImageUrl(cvPath);
  };
                ...
                <div className="application-main">
                  ...
                  <div>
                    ...
                    {application.candidateCVUrl ? (
                      <p>
                        <a
                          href={getCvLink(application.candidateCVUrl)}
                          target="_blank"
                          rel="noreferrer"
                        >
                          {application.candidateCVFileName || "View CV"}
                        </a>
                      </p>
                    ) : (
                      <p>No CV uploaded</p>
            ...
            <div className="application-details-grid">
              <div className="application-details-card">
                ...
                <p>
                  <span>CV</span>
                  <strong>
                    {selectedApplication.candidateCVUrl ? (
                      <a
                        href={getCvLink(selectedApplication.candidateCVUrl)}
                        target="_blank"
                        rel="noreferrer"
                      >
                        {selectedApplication.candidateCVFileName || "View CV"}
                      </a>
                    ) : (
                      "No CV uploaded"
                    )}
